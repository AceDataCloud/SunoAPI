...
SUNO allows us to obtain music in wav format files. This document explains the integration methods of the related API.
...
The `audio_id` we are inputting here is `ec13e502-d043-4eb2-92ee-e900c6da69d1`.
